...
# SSH 客户端连接
async def create_ssh_connection(ws, host, username, password=None, port=22):
    conn = await asyncssh.connect(host, username=username, password=password, port=port, known_hosts=None)
